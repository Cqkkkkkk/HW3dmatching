...
if __name__ == '__main__':
    processor = OptimizePointCloudProcessor(sampling_mode='random')
    processor.process_point_clouds()
    processor = QuaternionPointCloudProcessor(sampling_mode='random')
    processor.process_point_clouds()
    processor = SVDPointCloudProcessor(sampling_mode='random')
    processor.process_point_clouds()
